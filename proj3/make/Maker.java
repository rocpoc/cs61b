...
class Maker {
    ...
    void readFileAges(String fileInfoName) {
        ...
        name = "<unknown>";
        try {
            FileReader toread = new FileReader(new File(fileInfoName));
            ...
            make.Main.error(excp.getMessage());
        }
    }
    ...
    void readMakefile(String makefileName) {
        ...
        commands = null;
        try {
            FileReader toread = new FileReader(new File(makefileName));
            inp = new Scanner(toread);
        } catch (java.io.FileNotFoundException excp) {
